...
plt.savefig('R-vs-P.pdf', bbox_inches='tight')

# Surface temperature
PPrasad = [1.0, 5.0, 20.0, 50.0, 90.0]
RPrasad = [630, 670, 730, 750, 800]

PZenin = [1.0, 5.0, 20.0, 70.0]
RZenin = [360+273, 400+273, 460+273, 490+273]
...
plt.savefig('Ts-vs-P.pdf')

# Heat feedback
PPrasad = [1.0, 5.0, 20.0, 50.0, 90.0]
RPrasad = [1.51e5, 5.80e5, 8.70e5, 1.90e6, 2.95e6]

PZenin = [1.0, 5.0, 20.0, 70.0]
RZenin = [4e4, 14e4, 18e4, 30e4]
...
plt.savefig('Heatfeedback-vs-P.pdf')
